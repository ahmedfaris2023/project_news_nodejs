...
return (
    <section className='container mx-auto flex flex-col px-5 py-5 lg:flex-row'>
        ...
        <p className="text-dark-light mt-4 text-center md:text-xl lg:text-base xl:text-xl lg:text-left">Lorem ipsum dolor sit amet,consectetur adipscing elit
            ,sed do eiusmod temport incididunt ut labore et dolore magna aliqua
        </p>
        ...
        <div className='hidden lg:block lg:1/2'>
            <img className='w-full' src={images.HeroImage} alt="users and reading articles" />
        </div>
    </section>
  )
}
